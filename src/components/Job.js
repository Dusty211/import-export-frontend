...
const Job = (props) => {
  return(
    ...
    <JobOptions currentGamestate={props.currentGamestate} handleOptionSelection={props.handleOptionSelection} jobOptions={props.nextJob.job_options} setLoopStage={props.setLoopStage}/>
    </div>
  )
}
