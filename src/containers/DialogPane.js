    ...
    return(
      ...
      {this.props.loopStage === 0 ?
        <React.Fragment>
          ...
          <Job handleOptionSelection={this.handleOptionSelection} nextJob={this.props.nextJob.job} nextNpc={this.props.nextJob.npc}setLoopStage={this.props.setLoopStage}/>
        </React.Fragment> :
